...
//    }
    ...
    public Object testPost(TestPostRequest request) {
        Map<String, Object> m = new HashMap<>();
        m.put("dateTimeStr", DateTimeUtils.toLocalDateTime(request.getDateTimeStr(), DateTimeFormatter.ofPattern(DateTimeUtils.DEFAULT_LOCAL_DATE_TIME_PATTERN)));
        m.put("dateStr", DateTimeUtils.toLocalDate(request.getDateStr(), DateTimeFormatter.ofPattern(DateTimeUtils.DEFAULT_LOCAL_DATE_PATTERN)));
    ...
    public Object testPostForm(TestPostFormRequest request) {
        ...
        if (StringUtils.isNotBlank(request.getDateTime())) {
            m.put("dateTimeStr", DateTimeUtils.toLocalDateTime(request.getDateTime(), DateTimeFormatter.ofPattern(DateTimeUtils.DEFAULT_LOCAL_DATE_TIME_PATTERN)));
        }
        if (StringUtils.isNotBlank(request.getDate())) {
            m.put("dateStr", DateTimeUtils.toLocalDate(request.getDate(), DateTimeFormatter.ofPattern(DateTimeUtils.DEFAULT_LOCAL_DATE_PATTERN)));
        }
        return m;
    }
